...
mkdir -p ${project_dir}/gen-src/pssparser_gen
...
touch ${project_dir}/gen-src/pssparser_gen/__init__.py
cp ${project_dir}/gen-src/grammar/* ${project_dir}/gen-src/pssparser_gen
